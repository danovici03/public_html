...
<head>
  ...
  <title>Medisbook - Dashboard</title>
...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    <a class="navbar-brand" href="/dashboard"><img src="img/logo.png" data-retina="true" alt="" width="163" height="36"></a>
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Reviews">
        <a class="nav-link" href="/pacienti">
          <i class="fa fa-users" aria-hidden="true"></i>
          <span class="nav-link-text">Pacienti</span>
        </a>
      </li>
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
       <a class="nav-link" href="colegi">
        <i class="fa fa-user-md" aria-hidden="true"></i>
         <span class="nav-link-text">Colegii mei <span class="badge badge-pill badge-primary">6 New</span></span>
       </a>
     </li>
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Messages">
          <a class="nav-link" href="/mesaje">
            <i class="fa fa-fw fa-envelope-open"></i>
            <span class="nav-link-text">Mesaje</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Profilul meu">
...
<footer class="sticky-footer">
    <div class="container">
      <div class="text-center">
        <small>Copyright © Medisbook 2022</small>
      </div>
    </div>
  </footer>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Vrei sa iesi?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Alege "Logout" pentru a incheia sesiunea.</div>
